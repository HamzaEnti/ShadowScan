...
public class TestMotor {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 2. Tallem l'últim número per obtenir la xarxa (ex: "172.20.10.12"
-> "172.20.10.")
            // Busquem l'últim punt i agafem tot el que hi ha abans, incloent el
punt xarxaLocal = laMevaIp.substring(0, laMevaIp.lastIndexOf(".") + 1);

            System.out.println("--- Test de Logica Backend ---");
            System.out.println("Escanejant automàticament la xarxa: " +
xarxaLocal + "X");
            ...
            System.out.println("Error detectant la IP o durant el test: " +
